...
@section('main-content')
    ...
    <section class="jarallax bg-dark pt-2 pt-lg-3 pb-lg-5" data-jarallax data-speed="0.35" data-bs-theme="dark">
        ...
        <div class="container position-relative zindex-5 pb-5">
            ...
            <div class="d-flex align-items-center mt-xl-5 pt-2 pt-md-4 pt-lg-5">
                ...
                <div class="ps-3">
                    <div class="text-light opacity-80 mb-1">Created by</div>
                    <h6>Albert Flores</h6>
                </div>
            </div>
        </div>
    ...
    <section class="container pt-5 mt-2 mt-lg-4 mt-xl-5">
        <div class="row">
                    ...
                    <div class="pt-5 mt-md-3">
                        <div class="card shadow-sm p-sm-3">
                            <div class="card-body">
                                ...
                                <div class="h2 d-flex align-items-center mb-4">$28.99<del
                                        class="text-muted fs-xl fw-normal ms-2">49.99</del></div>
            ...
            <div class="col-xl-7 col-lg-8 col-md-7 order-md-1 mb-5">
                ...
                <p class="pb-4 mb-3">Suspendisse natoque sagittis, consequat turpis. Sed tristique tellus morbi magna. At
                    vel senectus accumsan, arcu mattis id tempor. Tellus sagittis, euismod porttitor sed tortor est id.
                    Feugiat velit velit, tortor ut. Ut libero cursus nibh lorem urna amet tristique leo. Viverra lorem arcu
                    nam nunc at ipsum quam. A proin id sagittis dignissim mauris condimentum ornare. Tempus mauris sed
                    dictum ultrices.</p>
                    ...
                    <div class="step">
                        ...
                        <div class="step-body">
                            ...
                            <p class="mb-0">Nulla faucibus mauris pellentesque blandit faucibus non. Sit ut et at
                                suspendisse gravida hendrerit tempus placerat.</p>
                        </div>
                    </div>
                    <div class="step">
                        <div class="step-number">
                        ...
                        <div class="step-body">
                            ...
                            <p class="mb-0">Lobortis diam elit id nibh ultrices sed penatibus donec. Nibh iaculis eu sit
                                cras ultricies. Nam eu eget etiam egestas donec scelerisque ut ac enim. Vitae ac nisl, enim
                                nec accumsan vitae est.</p>
                        </div>
                    </div>
                    <div class="step">
                        <div class="step-number">
                        ...
                        <div class="step-body">
                            ...
                            <p class="mb-0">Duis euismod enim, facilisis risus tellus pharetra lectus diam neque. Nec
                                ultrices mi faucibus est. Magna ullamcorper potenti elementum ultricies auctor.</p>
                        </div>
                    </div>
                    <div class="step">
                        <div class="step-number">
                        ...
                        <div class="step-body">
                            ...
                            <p class="mb-0">Morbi porttitor risus imperdiet a, nisl mattis. Amet, faucibus eget in platea
                                vitae, velit, erat eget velit. At lacus ut proin erat.</p>
                        </div>
                    </div>
                    <div class="step">
                        <div class="step-number">
                        ...
                        <div class="step-body">
                            ...
                            <p class="mb-0">Risus morbi euismod in congue scelerisque fusce pellentesque diam consequat.
                                Nisi mauris nibh sed est morbi amet arcu urna. Malesuada feugiat quisque consectetur
                                elementum diam vitae. Dictumst facilisis odio eu quis maecenas risus odio fames bibendum
                                ullamcorper.</p>
                        </div>
                    </div>
                    <div class="step">
                        ...
                        <div class="step-body">
                            ...
                            <p class="mb-0">Quis risus quisque diam diam. Volutpat neque eget eu faucibus sed urna
                                fermentum risus. Est, mauris morbi nibh massa.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="container py-lg-4 py-xl-5 mt-3 mb-5">
        <div class="row g-0 bg-dark bg-repeat-0 bg-position-center border rounded-3 overflow-hidden"
            style="background-image: url(assets/img/portfolio/courses/author-pattern.svg);">
            <div class="col-md-5 bg-repeat-0 bg-position-top-center bg-size-cover"
                style="background-image: url(assets/img/portfolio/courses/author.jpg); min-height: 350px;"></div>
            <div class="col-md-7 py-xl-5 px-4">
                <div class="py-5 mx-auto" style="max-width: 530px;">
                    ...
                    <p class="text-light opacity-70 pb-4">Dolor ipsum amet cursus quisque porta adipiscing. Lorem convallis
                        malesuada sed maecenas. Ac dui at vitae mauris cursus in nullam porta sem. Quis pellentesque
                        elementum ac bibendum. Nunc aliquam in tortor facilisis. Vulputate eget risus, metus phasellus.
                        Pellentesque faucibus amet, eleifend diam quam condimentum convallis ultricies placerat. Duis
                        habitasse placerat amet, odio pellentesque rhoncus, feugiat at. Eget pellentesque tristique felis
                        magna fringilla.</p>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-auto pt-4">
                        <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                            ...
                            <figcaption class="d-flex align-items-center ps-4 pt-4">
                                <img src="assets/img/avatar/03.jpg" width="48" class="rounded-circle"
                                    alt="Fannie Summers">
                                <div class="ps-3">
                    ...
                    <div class="swiper-slide h-auto pt-4">
                        <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                            ...
                            <figcaption class="d-flex align-items-center ps-4 pt-4">
                                <img src="assets/img/avatar/02.jpg" width="48" class="rounded-circle"
                                    alt="Robert Fox">
                                <div class="ps-3">
                    ...
                    <div class="swiper-slide h-auto pt-4">
                        <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                            ...
                            <figcaption class="d-flex align-items-center ps-4 pt-4">
                                <img src="assets/img/avatar/04.jpg" width="48" class="rounded-circle"
                                    alt="Annette Black">
                                <div class="ps-3">
                    ...
                    <div class="swiper-slide h-auto pt-4">
                        <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                            ...
                            <figcaption class="d-flex align-items-center ps-4 pt-4">
                                <img src="assets/img/avatar/07.jpg" width="48" class="rounded-circle"
            ...
            <div class="col-md-5 mb-4 mb-md-0">
                <div class="card bg-dark h-100 p-lg-5">
                    <div class="card-body p-lg-2">
                        <h2 class="h1 text-light">Still Have Any Questions?</h2>
                        <p class="fs-xl text-light opacity-70 mb-0">Check out the FAQs.</p>
                    </div>
                    <div class="card-footer border-0 w-100 pt-0 p-4 p-lg-2">
                        <div class="h2 d-flex align-items-center text-light mb-4">$28.99<del
                                class="fs-xl fw-normal opacity-70 ms-2">49.99</del></div>
                        <a href="#" class="btn btn-primary btn-lg shadow-primary">Join the course</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3" type="button"
                                ...
                                aria-controls="q-1">YouTube is full of free tutorials, videos and courses. Why should I
                                take courses here?</button>
                        </h3>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3 collapsed" type="button"
                                ...
                                aria-controls="q-2">What if I don't have any professional background?</button>
                        </h3>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3 collapsed" type="button"
                                ...
                                aria-controls="q-3">How is this different from other courses on the market?</button>
                        </h3>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3 collapsed" type="button"
                                ...
                                aria-controls="q-4">How much time does it take to do my homework per week? What if I don't
                                like it?</button>
                        </h3>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3 collapsed" type="button"
                                ...
                                aria-controls="q-5">Is there any kind of certificate of completion?</button>
                        </h3>
    ...
    <section class="bg-secondary pt-5 pb-4 pb-lg-5">
        <div class="container py-2 pt-lg-4 pb-lg-0">
            <h2 class="h1 text-center pb-4">More courses like this</h2>
                    ...
                    <div class="swiper-slide h-auto pb-3">
                        <article class="card h-100 border-0 shadow-sm mx-2">
                            <div class="position-relative">
                                <a href="#" class="d-block position-absolute w-100 h-100 top-0 start-0"
