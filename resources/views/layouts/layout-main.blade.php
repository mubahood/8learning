    ...
    <footer class="footer bg-secondary pt-5 pb-4 pb-lg-5">
        <div class="container pt-lg-4">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div id="useful-links" class="collapse d-lg-block" data-bs-parent="#footer-links">
                                <ul class="nav flex-column pb-lg-1 mb-lg-3">
                                    ...
                                    <li class="nav-item"><a href="#"
                                            class="nav-link d-inline-block px-0 pt-1 pb-2">Courses</a></li>
                                    <li class="nav-item"><a href="#"
                                            class="nav-link d-inline-block px-0 pt-1 pb-2">Careers</a></li>
                                    <li class="nav-item"><a href="#"
            ...
            <p class="nav d-block fs-xs text-center text-md-start pb-2 pb-lg-0 mb-0">
                ...
                <a class="nav-link d-inline-block p-0" href="#" rel="noopener">Createx
                    Studio</a>
            </p>
        </div>
    </footer>
